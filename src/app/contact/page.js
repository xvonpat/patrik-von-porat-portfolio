...
export default function Contact() {
  const contactLinks = [
    {
      name: "Spotify",
      url: "https://spotify.com", // Placeholder URLs
      subtext: "Listen to Realmforged, Freternia, Cromonic and Ashwrithe",
      accent: "purple",
    ...
    },
    {
      ...
      subtext: "Watch guitar playthroughs, music videos, and gear reviews",
      accent: "orange",
    ...
    },
    {
      ...
      subtext: "Traditional sketches, flash sheets, miniatures and studio logs",
      accent: "purple",
    ...
    },
    {
      ...
      subtext: "Support my art creation, guitar stems, and process methodologies",
      accent: "orange",
    ...
    },
    {
      ...
      subtext: "Buy digital albums, CD packages, and official band merchandise",
      accent: "cyan",
    ...
    },
    {
      ...
      subtext: "Process engineering, Lean Six Sigma consulting, and projects",
      accent: "cyan",
    ...
    {
      name: "Email",
      url: "mailto:patrik@example.com", // Placeholder Email
      subtext: "Reach out for music session collaborations or consultation questions",
      accent: "purple",
      ...
      <div className="flex flex-col gap-4 mt-6 relative z-10">
        {contactLinks.map((link, idx) => (
          ...
          >
            <GlassCard 
              accent={link.accent} 
              className="p-5! md:p-6! flex items-center justify-between transition-all duration-300 transform hover:scale-[1.01]"
            >
              <div className="flex items-center gap-6">
                {/* SVG Icon */}
                <div className={`w-12 h-12 rounded-lg bg-obsidian-950 flex items-center justify-center border border-white/5 group-hover:border-accent-${link.accent}/30 transition-all duration-300`}>
                  <svg 
                    className={`w-6 h-6 text-zinc-400 group-hover:text-accent-${link.accent} transition-colors duration-300`} 
                    fill="currentColor" 
                    viewBox="0 0 24 24"
                  >
