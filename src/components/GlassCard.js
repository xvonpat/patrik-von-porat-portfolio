...
export default function GlassCard({ 
  ...
  return (
    <div 
      onClick={onClick}
      className={`relative glass-panel rounded-xl p-5 md:p-6 transition-all duration-500 ease-out transform hover:-translate-y-1 ${selectedAccentClass} ${onClick ? 'cursor-pointer' : ''} ${className}`}
    >
