...
export default function GlassCard({ 
  ...
  return (
    <div 
      onClick={onClick}
      className={`glass-panel rounded-lg p-6 md:p-8 transition-all duration-500 ease-out transform hover:-translate-y-1 ${selectedAccentClass} ${onClick ? 'cursor-pointer' : ''} ${className}`}
    >
